...
public class CameraFboRender implements EglSurfaceView.Render, SurfaceTexture.OnFrameAvailableListener{
   private static final String TAG = "CameraFboRender";
    ...
    public void onSurfaceCreated() {
        program = ShaderHelper.buildProgram(TextResourceReader.readTextFileFromResource(context, R.raw.camera_vertex_shader),
                TextResourceReader.readTextFileFromResource(context, R.raw.camera_fragment_shader));
