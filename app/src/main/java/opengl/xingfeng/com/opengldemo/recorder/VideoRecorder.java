...
import opengl.xingfeng.com.opengldemo.filter.GLImageFilter;
import opengl.xingfeng.com.opengldemo.gles.EglCore;
import opengl.xingfeng.com.opengldemo.gles.WindowSurface;
import opengl.xingfeng.com.opengldemo.util.OpenGLUtils;
import opengl.xingfeng.com.opengldemo.util.TextureRotationUtils;
...
public final class VideoRecorder implements Runnable, VideoEncoder.OnEncodingListener {
     ...
     * @param params
     */
    private void onStartRecord(VideoParams params) {
        if (VERBOSE) {
